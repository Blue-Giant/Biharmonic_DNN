...
def solve_Biharmonic_Navier2D(R):
    ...
    Weights2psi_NN1, Bias2psi_NN1 = DNN_base.initialize_NN_random_normal2(input_dim, out_dim, hidden_layers, flag2psi_NN1)
    Weights2u_NN2, Bias2u_NN2 = DNN_base.initialize_NN_random_normal2(input_dim, out_dim, hidden_layers, flag2u_NN2)
    Weights2psi_NN2, Bias2psi_NN2 = DNN_base.initialize_NN_random_normal2(input_dim, out_dim, hidden_layers, flag2psi_NN2)
    ...
    with tf.device('/gpu:%s' % (R['gpuNo'])):
        with tf.variable_scope('vscope', reuse=tf.AUTO_REUSE):
            ...
            if R['model'] == 'PDE_DNN':
                Psi_NN1 = DNN_base.PDE_DNN(XY_it, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, activate_name=act_func1)
                PsiLeft_NN1 = DNN_base.PDE_DNN(XY_left_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, activate_name=act_func1)
                PsiRight_NN1 = DNN_base.PDE_DNN(XY_right_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, activate_name=act_func1)
                PsiBottom_NN1 = DNN_base.PDE_DNN(XY_bottom_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, activate_name=act_func1)
                PsiTop_NN1 = DNN_base.PDE_DNN(XY_top_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, activate_name=act_func1)

                U_NN1 = DNN_base.PDE_DNN(XY_it, Weights2u_NN1, Bias2u_NN1, hidden_layers, activate_name=act_func1)
                ULeft_NN1 = DNN_base.PDE_DNN(XY_left_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, activate_name=act_func1)
                URight_NN1 = DNN_base.PDE_DNN(XY_right_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, activate_name=act_func1)
                UBottom_NN1 = DNN_base.PDE_DNN(XY_bottom_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, activate_name=act_func1)
                UTop_NN1 = DNN_base.PDE_DNN(XY_top_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, activate_name=act_func1)

                Psi_NN2 = DNN_base.PDE_DNN(XY_it, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, activate_name=act_func2)
                PsiLeft_NN2 = DNN_base.PDE_DNN(XY_left_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, activate_name=act_func2)
                PsiRight_NN2 = DNN_base.PDE_DNN(XY_right_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, activate_name=act_func2)
                PsiBottom_NN2 = DNN_base.PDE_DNN(XY_bottom_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, activate_name=act_func2)
                PsiTop_NN2 = DNN_base.PDE_DNN(XY_top_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, activate_name=act_func2)

                U_NN2 = DNN_base.PDE_DNN(XY_it, Weights2u_NN2, Bias2u_NN2, hidden_layers, activate_name=act_func2)
                ULeft_NN2 = DNN_base.PDE_DNN(XY_left_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, activate_name=act_func2)
                URight_NN2 = DNN_base.PDE_DNN(XY_right_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, activate_name=act_func2)
                UBottom_NN2 = DNN_base.PDE_DNN(XY_bottom_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, activate_name=act_func2)
                UTop_NN2 = DNN_base.PDE_DNN(XY_top_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, activate_name=act_func2)

            elif R['model'] == 'PDE_DNN_scale':
                freq = np.concatenate(([1], np.arange(1, 100 - 1)), axis=0)
                Psi_NN1 = DNN_base.PDE_DNN_scale(XY_it, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, freq, activate_name=act_func1)
                PsiLeft_NN1 = DNN_base.PDE_DNN_scale(XY_left_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, freq, activate_name=act_func1)
                PsiRight_NN1 = DNN_base.PDE_DNN_scale(XY_right_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, freq, activate_name=act_func1)
                PsiBottom_NN1 = DNN_base.PDE_DNN_scale(XY_bottom_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, freq, activate_name=act_func1)
                PsiTop_NN1 = DNN_base.PDE_DNN_scale(XY_top_bd, Weights2psi_NN1, Bias2psi_NN1, hidden_layers, freq, activate_name=act_func1)

                U_NN1 = DNN_base.PDE_DNN_scale(XY_it, Weights2u_NN1, Bias2u_NN1, hidden_layers, freq, activate_name=act_func1)
                ULeft_NN1 = DNN_base.PDE_DNN_scale(XY_left_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, freq, activate_name=act_func1)
                URight_NN1 = DNN_base.PDE_DNN_scale(XY_right_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, freq, activate_name=act_func1)
                UBottom_NN1 = DNN_base.PDE_DNN_scale(XY_bottom_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, freq, activate_name=act_func1)
                UTop_NN1 = DNN_base.PDE_DNN_scale(XY_top_bd, Weights2u_NN1, Bias2u_NN1, hidden_layers, freq, activate_name=act_func1)

                Psi_NN2 = DNN_base.PDE_DNN_scale(XY_it, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, freq, activate_name=act_func2)
                PsiLeft_NN2 = DNN_base.PDE_DNN_scale(XY_left_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, freq, activate_name=act_func2)
                PsiRight_NN2 = DNN_base.PDE_DNN_scale(XY_right_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, freq, activate_name=act_func2)
                PsiBottom_NN2 = DNN_base.PDE_DNN_scale(XY_bottom_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, freq, activate_name=act_func2)
                PsiTop_NN2 = DNN_base.PDE_DNN_scale(XY_top_bd, Weights2psi_NN2, Bias2psi_NN2, hidden_layers, freq, activate_name=act_func2)

                U_NN2 = DNN_base.PDE_DNN_scale(XY_it, Weights2u_NN2, Bias2u_NN2, hidden_layers, freq, activate_name=act_func2)
                ULeft_NN2 = DNN_base.PDE_DNN_scale(XY_left_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, freq, activate_name=act_func2)
                URight_NN2 = DNN_base.PDE_DNN_scale(XY_right_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, freq, activate_name=act_func2)
                UBottom_NN2 = DNN_base.PDE_DNN_scale(XY_bottom_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, freq, activate_name=act_func2)
                UTop_NN2 = DNN_base.PDE_DNN_scale(XY_top_bd, Weights2u_NN2, Bias2u_NN2, hidden_layers, freq, activate_name=act_func2)

            X_it = tf.reshape(XY_it[:, 0], shape=[-1, 1])
            Y_it = tf.reshape(XY_it[:, 1], shape=[-1, 1])
            dPsi_NN1 = tf.gradients(Psi_NN1,  XY_it)[0]
            dU_NN1 = tf.gradients(U_NN1,  XY_it)[0]

            dPsi_NN2 = tf.gradients(Psi_NN2, XY_it)[0]
            ...
            if R['variational_loss'] != 0:
                ...
                loss_it2Psi_NN1 = tf.reduce_mean(0.5*laplace2Psi_NN1 - tf.multiply(Psi_NN1, f(X_it, Y_it)))
                ...
                loss_it2Psi_NN2 = tf.reduce_mean(0.5 * laplace2Psi_NN2 - tf.multiply(Psi_NN2, f(X_it, Y_it)))
    ...
    with tf.Session(config=config) as sess:
        ...
        for i_epoch in range(R['max_epoch'] + 1):
            ...
            _, lossU_nn1, lossPsi_nn1, loss_Ubd_nn1, loss_Psibd_nn1, loss_nn1, train_mse_nn1, train_rel_nn1 = \
                sess.run([train_loss_NN1, loss2U_NN1, loss2Psi_NN1, loss_Ubd_NN1, loss_Psibd_NN1, loss_NN1,
                          train_mse_NN1, train_rel_NN1], feed_dict={XY_it: xy_it_batch, XY_left_bd: xl_bd_batch,
                                                                    XY_right_bd: xr_bd_batch,XY_bottom_bd: yb_bd_batch,
                                                                    XY_top_bd: yt_bd_batch, in_learning_rate: tmp_lr,
            ...
            _, lossU_nn2, lossPsi_nn2, lossUbd_nn2, lossPsibd_nn2, loss_nn2, train_mse_nn2, train_rel_nn2 = \
                sess.run([train_loss_NN2, loss2U_NN2, loss2Psi_NN2, loss_Ubd_NN2, loss_Psibd_NN2, loss_NN2,
                          train_mse_NN2, train_rel_NN2], feed_dict={XY_it: xy_it_batch, XY_left_bd: xl_bd_batch,
                                                                    XY_right_bd: xr_bd_batch, XY_bottom_bd: yb_bd_batch,
                                                                    XY_top_bd: yt_bd_batch, in_learning_rate: tmp_lr,
                                                                    train_opt: train_option, bd_penalty: temp_penalty_bd})
            ...
            if i_epoch % 1000 == 0:
                ...
                print('residual error of predict and real for testing: %10f\n' % test_rel2nn1)
                DNN_tools.log_string('mean square error of predict and real for testing: %10f' % test_mse2nn1, log_fileout_NN1)
                DNN_tools.log_string('residual error of predict and real for testing: %10f\n\n' % test_rel2nn1, log_fileout_NN1)

                print('mean square error of predict and real for testing: %10f' % test_mse2nn2)
                print('residual error of predict and real for testing: %10f\n' % test_rel2nn2)
                DNN_tools.log_string('mean square error of predict and real for testing: %10f' % test_mse2nn2, log_fileout_NN2)
                DNN_tools.log_string('residual error of predict and real for testing: %10f\n\n' % test_rel2nn2, log_fileout_NN2)

        # -----------------------save the results into mat, then plot them ---------------------
        saveData.save_trainLoss2mat_1actFunc_Navier(
            lossU_NN1, lossUBD_NN1, lossPsi_NN1, lossPsiBD_NN1, loss_All2NN1, actName=act_func1, outPath=R['FolderName'])
        saveData.save_trainLoss2mat_1actFunc_Navier(
            lossU_NN2, lossUBD_NN2, lossPsi_NN2, lossPsiBD_NN2, loss_All2NN2, actName=act_func2, outPath=R['FolderName'])
        ...
        plotData.plotTrain_losses_2act_funs(lossPsiBD_NN1, lossPsiBD_NN2, lossName1=act_func1, lossName2=act_func2,
        ...
        plotData.plot_Test_MSE_REL_2ActFuncs(test_mse_NN1, test_mse_NN2, test_rel_NN1, test_rel_NN2, epoches=test_epoch,
                                             actName1=act_func1, actName2=act_func2, seedNo=R['seed'],
                                             outPath=R['FolderName'], yaxis_scale=True)

        saveData.save_test_point_wise_err2mat(point_square_error_NN1, actName=act_func1, outPath=R['FolderName'])
        saveData.save_test_point_wise_err2mat(point_square_error_NN2, actName=act_func2, outPath=R['FolderName'])
...
if __name__ == "__main__":
    ...
    R['hidden_layers'] = (50, 40, 40, 30, 20, 20)      # 2D问题选这个时，s2relu的效果很好
    # R['hidden_layers'] = (80, 60, 60, 40, 40, 20)
